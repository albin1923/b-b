...
export default function AdminPage() {
  ...
  const handleNewsSubmit = async (event) => {
    ...
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : 'Failed to save news item')
    } finally {
      setBusy(false)
    }
  }
              ...
              <div className={styles.itemList}>
                {newsItems.map((item) => (
                  <div key={item.id} className={styles.itemCard}>
                    <img src={item.imageUrl || '/images/slider-1.png'} alt={item.title} />
            ...
            <article className={styles.listCard}>
              ...
              <div className={styles.itemList}>
                {galleryItems.map((item) => (
                  <div key={item.id} className={styles.itemCard}>
                    <img src={item.imageUrl || '/images/rooms/studio.jpg'} alt={item.alt} />
                    <div className={styles.itemBody}>
                      <h3>{item.title}</h3>
